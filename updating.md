...
![The BB SG img file and the MicroSD card are both selected and ready to be flashed](.gitbook/assets/betcher%20%281%29%20%282%29%20%282%29.png)
...
![Ensure that mini USB \(a\) and the barrel jack \(b\) ports are disconnected from power](.gitbook/assets/bbpower%20%281%29%20%282%29%20%282%29%20%282%29.jpg)
